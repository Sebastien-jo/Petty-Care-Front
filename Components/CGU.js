  ...
  return (
        <View style={Style.container}>
            ...
            <View>
                ...
                <Text style={Style.currentText}>1. Vous choisissez qui peut voir et contrôler vos produits Petty Care.</Text>
                
                <Text style={Style.currentText}>2. Nous améliorons constamment nos produits et services, c’est la raison pour laquelle certaines fonctions ou fonctionnalités sont susceptibles d’évoluer au fil du temps.</Text>
            </View>

            <View>
                <Text style={Style.currentText}>Vous pouvez lire l’intégralité des Conditions d’utilisation ci-dessous. Vous souhaitez les relire ? Elles sont égalements disponibles dans la section Paramètres.
                </Text>
            </View>
